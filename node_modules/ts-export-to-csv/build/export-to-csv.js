...
var ExportToCsv = /** @class */ (function () {
    ...
    ExportToCsv.prototype._getHeaders = function () {
        ...
        var headers = this._options.additionalHeaders;
        var row = "";
        for (var keyPos = 0; keyPos < headers.length; keyPos++) {
            headers[keyPos].columns.forEach(function (header) {
                row += _this._formatData(header) + _this._options.fieldSeparator;
            });
            row = row.slice(0, -1);
     ...
     */
    ExportToCsv.prototype._getColumnHeaders = function () {
        if (!this._options.showLabels && !this._options.useKeysAsHeaders) {
            return;
        }
        var useKeysAsHeaders = this._options.useKeysAsHeaders;
        var headers = useKeysAsHeaders ? Object.keys(this._data[0]) : this._options.columnHeaders;
        if (headers.length > 0) {
            var row = "";
            for (var keyPos = 0; keyPos < headers.length; keyPos++) {

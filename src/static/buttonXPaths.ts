export enum ButtonXPaths_A8 {
    ...
    UPLOADTODAYLOG = '//android.widget.Button[@content-desc="上传当天日志"]',
    UPLOADOTHERDAYLOG = '//android.widget.Button[@content-desc="上传其他日期日志"]',
    ORDERTEXT='//android.widget.Button[@content-desc="申请退货"]',
}
...
export enum ButtonXPaths_Elo{
    ...
    SYSTEMLOGOUT = '//android.widget.Button[@content-desc="退出程序"]',
    UPLOADLOG = '//android.widget.Button[@content-desc="上传日志"]',
    UPLOADTODAYLOG = '//android.widget.Button[@content-desc="上传当天日志"]',
    UPLOADOTHERDAYLOG = '//android.widget.Button[@content-desc="上传其他日期日志"]',

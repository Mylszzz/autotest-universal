...
export class PaymentProcessing {
    ...
    public static async selectCardType(client:any){
        ...
        try {
            ...
            else if (GlobalUtil.map.get('CardType')==='实体卡') {
    ...
    // 扫码框
    public static async scanCode(client:any){
        // 扫码框
        try {
            // 扫码框
    ...
    // 取消交易
    public static async cancelTheDeal(client:any){
    ...
    // 支付出错的提示
    public static async errorTip(client:any){
        try {
